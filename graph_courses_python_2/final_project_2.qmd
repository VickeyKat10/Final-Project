...
```
## The linegraph depicts a gradual increase in the number of HIV deathsfrom 1990 - 2005 and a gradual decrease from 2005 onwards.
...
fig_violin = px.violin(
    ...
    y="country",
    color="country",
    title="Annual HIV deaths in selected countries",
    box=True,
    points="all",
